...
class FirestoreService {
  ...
  Future<bool> checkUserExistsByUid(String uid) async {
    try {
      ...
      print("🔥 Firestore checkUserExistsByUid error: $e");
      return false;
    }
  }
    ...
    try {
      ...
      try {
        ...
        if (isIndexError) {
          ...
          if (kDebugMode) {
            print(
              '⚠️ Index not found for email query, falling back to query all and filter',
            );
          }
          usedFallback = true;
      ...
      if (usedFallback) {
        ...
        if (kDebugMode) {
          print(
            '${userExists ? "✅" : "❌"} User ${userExists ? "exists" : "does not exist"} with email: $email (fallback query)',
          );
        }
        return userExists;
      }
      ...
      if (kDebugMode) {
        print(
          '${exists ? "✅" : "❌"} User ${exists ? "exists" : "does not exist"} with email: $email',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.checkUserExistsByEmail',
      );
  ...
  Future<void> addFavoriteFestival(String userId, int festivalId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.addFavoriteFestival',
      );
      rethrow;
    }
  }
  ...
  Future<List<int>> getFavoriteFestivalIds(String userId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getFavoriteFestivalIds',
      );
      rethrow;
    }
  }
  ...
  Future<bool> isFestivalFavorited(String userId, int festivalId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.isFestivalFavorited',
      );
      rethrow;
    }
  }
  ...
  Future<bool> isFestivalRumorUser(String userId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.isFestivalRumorUser',
      );
      rethrow;
    }
  }
    ...
    try {
      ...
      if (dataToSave['createdAt'] is DateTime) {
        dataToSave['createdAt'] = Timestamp.fromDate(
          dataToSave['createdAt'] as DateTime,
        );
      ...
      if (kDebugMode) {
        print(
          'Post saved to Firestore collection "$targetCollection": ${docRef.id}',
        );
      }
      ...
      if (!skipUserPostCountIncrement &&
        ...
        try {
          if (kDebugMode) {
            print(
              '🔄 Incrementing post count by $mediaCount (1 per post) for user: $userId',
            );
          }
  ...
  Future<String> saveJob(
    ...
    try {
      ...
      if (dataToSave['postedDate'] is DateTime) {
        dataToSave['postedDate'] = Timestamp.fromDate(
          dataToSave['postedDate'] as DateTime,
        );
      ...
      if (kDebugMode) {
        print(
          '✅ Job saved to Firestore collection "$collectionName": ${docRef.id}',
        );
      }
  ...
  Future<Map<String, List<Map<String, dynamic>>>> getUserJobs(
    String userId,
  ) async {
    try {
      if (kDebugMode) {
        ...
        try {
          ...
          try {
            ...
            if (isIndexError) {
              ...
              if (kDebugMode) {
                print(
                  '⚠️ Index not found for $collectionName, falling back to in-memory sort',
                );
              }
              querySnapshot =
                  await _firestore
  ...
  Future<Map<String, dynamic>> getAllJobsPaginated({
    ...
    try {
      ...
      for (final category in categories) {
        ...
        try {
          ...
          if (jobs.isNotEmpty) {
            ...
            if (kDebugMode) {
              print(
                '✅ Found ${jobs.length} jobs in category "$category" (hasMore: $hasMore)',
              );
            }
          } else {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getAllJobsPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<void> updateJob(
    ...
    try {
      ...
      if (dataToUpdate['postedDate'] is DateTime) {
        dataToUpdate['postedDate'] = Timestamp.fromDate(
          dataToUpdate['postedDate'] as DateTime,
        );
      }
  ...
  Future<void> deleteAllUserPosts(String userId) async {
    try {
      ...
      for (final collectionName in collections) {
        try {
          ...
          try {
            ...
            if (kDebugMode) {
              print(
                '✅ Using indexed query - found ${postsToDelete.length} posts for user',
              );
            }
          } catch (e) {
            // Check if this is a Firestore index error (FAILED_PRECONDITION)
            ...
            if (isIndexError) {
              ...
              if (kDebugMode) {
                ...
                print(
                  '⚠️ Falling back to paginated query with in-memory filtering',
                );
                print(
                  '⚠️ This will be SLOW for large collections. Please create the index!',
                );
                print(
                  '⚠️ Index needed: userId (Ascending) on collection: $collectionName',
                );
              }
              ...
              do {
                Query paginatedQuery = _firestore
                    .collection(collectionName)
                    .limit(batchSize);
                if (lastDoc != null) {
              ...
              if (kDebugMode) {
                print(
                  '⚠️ Scanned $totalScanned documents, found ${postsToDelete.length} matching posts',
                );
                print(
                  '⚠️ Efficiency: ${((postsToDelete.length / totalScanned) * 100).toStringAsFixed(1)}% match rate',
                );
              }
            } else {
              rethrow;
          ...
          if (totalDeleted > 0 && kDebugMode) {
            print(
              '✅ Deleted $totalDeleted posts from collection "$collectionName"',
            );
          }
        } catch (e) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.deleteAllUserPosts',
      );
      rethrow;
    }
  }
  ...
  Future<void> deleteUserProfile(String userId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.deleteUserProfile',
      );
      rethrow;
    }
  }
  ...
  Future<void> cleanupUserChatRooms(String userId) async {
    try {
      ...
      try {
        ...
        if (isIndexError) {
          ...
          final allRoomsSnapshot =
              await _firestore.collection('chatRooms').get();

          createdRooms =
              allRoomsSnapshot.docs.where((doc) {
                final data = doc.data() as Map<String, dynamic>;
        ...
        try {
          ...
          if (!isPublic) {
            ...
            for (int i = 0; i < messagesSnapshot.docs.length; i += batchSize) {
              ...
              final endIndex =
                  (i + batchSize < messagesSnapshot.docs.length)
                      ? i + batchSize
      ...
      for (int i = 0; i < roomsToUpdate.length; i += batchSize) {
        final batch = _firestore.batch();
        final endIndex =
            (i + batchSize < roomsToUpdate.length)
                ? i + batchSize
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.cleanupUserChatRooms',
      );
      rethrow;
    }
  }
  ...
  Future<void> deleteAllUserJobs(String userId) async {
    try {
        ...
        try {
          ...
          try {
            ...
            if (isIndexError) {
              ...
              if (kDebugMode) {
                print(
                  '⚠️ Index not found for $collectionName, falling back to query all and filter',
                );
              }
              querySnapshot = await _firestore.collection(collectionName).get();
            } else {
          ...
          for (int i = 0; i < jobsToDelete.length; i += batchSize) {
            final batch = _firestore.batch();
            final endIndex =
                (i + batchSize < jobsToDelete.length)
                    ? i + batchSize
                    : jobsToDelete.length;
          ...
          if (deletedInCategory > 0) {
            ...
            if (kDebugMode) {
              print(
                '✅ Deleted $deletedInCategory jobs from category "$category"',
              );
            }
          }
        } catch (e) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.deleteAllUserJobs',
      );
      rethrow;
    }
  }
  ...
  Future<void> incrementUserPostCount(String userId, {int count = 1}) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.incrementUserPostCount',
      );
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> getUserPostsPaginated({
    ...
    bool?
    isVideoOnly, // null = all posts, true = only videos, false = only images
    int limit = 20,
    ...
    try {
      ...
      for (var doc in querySnapshot.docs) {
        ...
        if (isVideoOnly != null) {
          ...
          final hasVideo =
              isVideo ||
              (isVideoList != null && isVideoList.any((v) => v == true));
      ...
      if (kDebugMode) {
        print(
          'Fetched ${posts.length} user posts from collection "$collectionName" for userId: $userId (hasMore: $hasMore)',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserPostsPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getUserPosts({
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'Fetched ${posts.length} user posts from collection "$collectionName" for userId: $userId',
        );
      }
    ...
    for (var post in posts) {
      ...
      if (mediaPaths != null && mediaPaths.isNotEmpty) {
        ...
        for (int i = 0; i < mediaPaths.length; i++) {
          final isVideo =
              (isVideoList != null && i < isVideoList.length)
      ...
      if (mediaPaths != null && mediaPaths.isNotEmpty) {
        ...
        if (firstImageUrl != null && firstImageUrl.trim().isNotEmpty) {
          postInfos.add({
            'postId': postId,
            'mediaUrl':
                firstImageUrl, // First image (matches _extractImagesFromPosts)
      ...
      if (mediaPaths != null && mediaPaths.isNotEmpty) {
        ...
        if (firstVideoUrl != null && firstVideoUrl.trim().isNotEmpty) {
          postInfos.add({
            'postId': postId,
            'mediaUrl':
                firstVideoUrl, // First video (matches _extractVideosFromPosts)
            'collectionName': collectionName,
            'isVideo': true,
            'hasMultipleMedia':
                hasMultipleMedia, // Flag to show icon overlay (true if multiple videos)
          });
        }
      } else if (post['imagePath'] != null &&
          (post['isVideo'] as bool? ?? false)) {
  ...
  Future<Map<String, dynamic>> getUserImagesPaginated(
    ...
    lastDocuments, // Map of collectionName -> lastDocument
    bool useCache = true,
  }) async {
    try {
      ...
      if (festivalCollectionNames != null &&
          festivalCollectionNames.isNotEmpty) {
          ...
          collectionQueries.add(
            getUserPostsPaginated(
                ...
                .timeout(
                  ...
                  onTimeout: () {
                    if (kDebugMode)
                      print('Timeout fetching from $collectionName');
                    return {
                      'posts': <Map<String, dynamic>>[],
                      'lastDocument': null,
                      'hasMore': false,
      ...
      final results = await Future.wait(collectionQueries).timeout(
        ...
        onTimeout: () {
          ...
          return List<Map<String, dynamic>>.filled(collectionQueries.length, {
            'posts': <Map<String, dynamic>>[],
            'lastDocument': null,
            'hasMore': false,
          });
      ...
      allPostInfos.addAll(
        _extractPostInfoFromPosts(globalPosts, defaultPostsCollection),
      );
      if (globalResult['lastDocument'] != null) {
        newLastDocuments[defaultPostsCollection] =
            globalResult['lastDocument'] as DocumentSnapshot;
      }
      ...
      if (festivalCollectionNames != null &&
        ...
        for (var collectionName in limitedCollections) {
          ...
          if (result['lastDocument'] != null) {
            newLastDocuments[collectionName] =
      ...
      if (kDebugMode) {
        print(
          'Found ${allImages.length} images for user: $userId (hasMore: $hasMore)',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserImagesPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<List<String>> getUserImages(
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserImages',
      );
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> getUserVideosPaginated(
    ...
    try {
      ...
      allPostInfos.addAll(
        _extractVideoInfoFromPosts(globalPosts, defaultPostsCollection),
      );
      if (globalResult['lastDocument'] != null) {
        newLastDocuments[defaultPostsCollection] =
            globalResult['lastDocument'] as DocumentSnapshot;
      ...
      if (festivalCollectionNames != null &&
        ...
        for (var collectionName in limitedCollections) {
          ...
          allPostInfos.addAll(
            _extractVideoInfoFromPosts(posts, collectionName),
          );
      ...
      if (kDebugMode) {
        print(
          'Found ${allVideos.length} videos for user: $userId (hasMore: $hasMore)',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserVideosPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<List<String>> getUserVideos(
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserVideos',
      );
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getPosts({
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'Fetched ${posts.length} posts from Firestore collection "$targetCollection"',
        );
      }
  ...
  Future<Map<String, dynamic>> getPostsPaginated({
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'Fetched ${posts.length} posts (paginated, limit: $limit) from Firestore collection "$targetCollection"',
        );
      }
      ...
      if (querySnapshot.docs.length == limit && newLastDocument != null) {
        try {
          ...
          if (kDebugMode) {
            print(
              'Has more posts check: ${hasMore} (fetched ${posts.length}, limit: $limit)',
            );
          }
        } catch (e) {
          if (kDebugMode) {
        ...
        if (kDebugMode) {
          print(
            'No more posts: fetched ${posts.length} which is less than limit $limit',
          );
        }
      }
      ...
      return query
          ...
          .handleError((error, stackTrace) {
            ...
            _errorHandler.handleError(
              exception,
              stackTrace,
              'FirestoreService.getPostsStream',
            );
          })
          .map((querySnapshot) {
            final posts = <Map<String, dynamic>>[];
            ...
            if (kDebugMode) {
              print(
                'Real-time update: ${posts.length} posts from Firestore collection "$targetCollection"',
              );
            }
  ...
  Future<void> updatePostLikes(
    ...
    try {
      ...
      await _firestore.collection(targetCollection).doc(postId).update({
        'likes': newLikesCount,
        'updatedAt': FieldValue.serverTimestamp(),
      });
    } catch (e, stackTrace) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.updatePostLikes',
      );
      rethrow;
    }
  }
  ...
  Future<void> updatePostComments(
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.updatePostComments',
      );
      rethrow;
    }
  }
  ...
  Future<void> saveUserReaction(
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'User reaction saved: postId=$postId, userId=$userId, emotion=$emotion, previousEmotion=$previousEmotion',
        );
      }
    } catch (e, stackTrace) {
      final exception = ExceptionMapper.mapToAppException(e, stackTrace);
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.saveUserReaction',
      );
      rethrow;
    }
  }
  ...
  Future<String?> getUserReaction(
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUserReaction',
      );
      rethrow;
    }
  }
  ...
  Future<Map<String, String>> getUserReactions(
    ...
    if (collectionName != null) {
      return _getUserReactionsFallback(
        postIds,
        userId,
        collectionName: collectionName,
      );
    ...
    try {
      ...
      final querySnapshot =
          await _firestore
              .collectionGroup(
                'reactions',
              ) // Query across all 'reactions' subcollections
              .where('userId', isEqualTo: userId)
              .get();
      ...
      if (kDebugMode) {
        print(
          'Loaded ${reactions.length} user reactions in single query (was ${postIds.length} separate reads)',
        );
      }
      ...
      if (kDebugMode) {
        print(
          'Collection group query failed, falling back to individual reads: $e',
        );
      }
  ...
  Future<Map<String, String>> _getUserReactionsFallback(
    ...
    try {
      ...
      final futures = postIds.map((postId) async {
        final emotion = await getUserReaction(
          postId,
          userId,
          collectionName: collectionName,
        );
      ...
      if (kDebugMode) {
        print(
          'Loaded ${reactions.length} user reactions using fallback method',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService._getUserReactionsFallback',
      );
      rethrow;
    }
  }
  ...
  Future<String> saveComment({
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'Comment saved: postId=$postId, commentId=${commentRef.id}, parentCommentId=$parentCommentId',
        );
      }
      ...
      return _firestore
          ...
          .handleError((error, stackTrace) {
            ...
            _errorHandler.handleError(
              exception,
              stackTrace,
              'FirestoreService.getRepliesStream',
            );
          })
          .map((querySnapshot) {
            ...
            if (kDebugMode) {
              print(
                'Real-time update: ${replies.length} replies for comment: $parentCommentId',
              );
            }
  ...
  Future<Map<String, dynamic>?> getPostById({
    ...
    try {
      final doc = await _firestore.collection(collectionName).doc(postId).get();
  ...
  Future<Map<String, dynamic>> getCommentsPaginated({
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'Fetched ${comments.length} comments (paginated, limit: $limit) for post: $postId',
        );
      }
      ...
      if (querySnapshot.docs.length == limit && newLastDocument != null) {
        try {
          ...
          if (kDebugMode) {
            print(
              'Has more comments check: ${hasMore} (fetched ${comments.length}, limit: $limit)',
            );
          }
        } catch (e) {
          if (kDebugMode) {
        ...
        if (kDebugMode) {
          print(
            'No more comments: fetched ${comments.length} which is less than limit $limit',
          );
        }
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getCommentsPaginated',
      );
      rethrow;
    }
  }
    ...
    try {
      ...
      return _firestore
          ...
          .map((querySnapshot) {
            ...
            if (kDebugMode) {
              print(
                'Real-time update: ${comments.length} top-level comments for post: $postId',
              );
            }
  ...
  Future<void> removeUserReaction(
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'User reaction removed: postId=$postId, userId=$userId, emotion=$emotion',
        );
      }
    } catch (e, stackTrace) {
      final exception = ExceptionMapper.mapToAppException(e, stackTrace);
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.removeUserReaction',
      );
      rethrow;
    }
  }
  ...
  Future<bool> checkChatRoomExists(String chatRoomId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.checkChatRoomExists',
      );
      return false;
    }
  }
  ...
  Future<List<String>> getAllFestivalRumorUserIds() async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getAllFestivalRumorUserIds',
      );
      return [];
    }
  }
  ...
  Future<String> createPublicChatRoom({
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.createPublicChatRoom',
      );
      rethrow;
    }
  }
  ...
  Future<void> addUserToAllPublicChatRooms(String userId) async {
    try {
      ...
      for (int i = 0; i < docs.length; i += maxBatchSize) {
        ...
        if (kDebugMode) {
          print(
            '✅ Added user $userId to ${batchDocs.length} public chat rooms (batch ${(i ~/ maxBatchSize) + 1})',
          );
        }
      }
      ...
      if (kDebugMode) {
        print(
          '✅ Successfully added user $userId to all ${docs.length} public chat rooms',
        );
      }
    } catch (e, stackTrace) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.addUserToAllPublicChatRooms',
      );
  ...
  Future<bool> deleteChatMessageForEveryone({
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.deleteChatMessageForEveryone',
      );
      rethrow;
    }
  }
  ...
  Future<Map<String, String>> getUsersByPhoneNumbers(
    ...
    try {
              ...
              if (storedPhone != null) {
                ...
                for (var contactNormalized in batch) {
                  if (storedNormalized == contactNormalized) {
                    final originalPhone =
                        normalizedToOriginal[contactNormalized]!;
      ...
      if (unmatchedPhones.isNotEmpty) {
        try {
          ...
          if (unmatchedLast10Set.isNotEmpty) {
            ...
            do {
              ...
              for (var doc in pageSnapshot.docs) {
                ...
                if (storedPhone != null && storedPhone.isNotEmpty) {
                  ...
                  if (last10.length >= 10 &&
                      unmatchedLast10Set.contains(last10)) {
                    if (!last10ToUserId.containsKey(last10)) {
                      last10ToUserId[last10] = [];
                    }
                    last10ToUserId[last10]!.add(
                      MapEntry(storedNormalized, doc.id),
                    );
                  }
                }
              }
            ...
            if (kDebugMode) {
              print(
                '📄 Fetched $totalFetched users in $pageCount pages for fallback matching',
              );
            }
          }
        } catch (e) {
      ...
      if (kDebugMode) {
        print(
          '✅ Found ${phoneToUserId.length} users matching phone numbers out of ${phoneNumbers.length} contacts',
        );
      }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getUsersByPhoneNumbers',
      );
      rethrow;
    }
  }
  ...
  Future<bool> privateChatRoomNameExists(
    String chatRoomName,
    String userId,
  ) async {
    try {
      ...
      for (var doc in createdRoomsQuery.docs) {
        ...
        if (existingName != null) {
          ...
          if (normalizedName == normalizedExisting) {
            if (kDebugMode) {
              print(
                '⚠️ Private chat room with name "$chatRoomName" already exists (created by user)',
              );
            }
            return true;
          }
      ...
      for (var doc in memberRoomsQuery.docs) {
        ...
        if (existingName != null) {
          ...
          if (normalizedName == normalizedExisting) {
            if (kDebugMode) {
              print(
                '⚠️ Private chat room with name "$chatRoomName" already exists (user is member)',
              );
            }
            return true;
          }
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.privateChatRoomNameExists',
      );
  ...
  Future<bool> deletePrivateChatRoom({
    ...
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.deletePrivateChatRoom',
      );
      rethrow;
    }
  }
  ...
  Future<void> deletePost({
    ...
    try {
      ...
      try {
        ...
        if (kDebugMode) {
          print(
            '🔢 Post counter decrement: Will decrement by 1 (post had ${mediaPaths.length} media items)',
          );
        }
  ...
  Future<void> decrementUserPostCount(String userId, {int count = 1}) async {
    try {
      ...
      if (newCount != currentCount) {
        ...
        if (kDebugMode) {
          print(
            '⚠️ Post count already at minimum (0), cannot decrement further',
          );
        }
      }
    } catch (e, stackTrace) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.decrementUserPostCount',
      );
  ...
  Future<void> followUser(String currentUserId, String targetUserId) async {
    try {
      ...
      if (isAlreadyFollowing) {
        if (kDebugMode) {
          print(
            'ℹ️ [followUser] User $currentUserId is already following $targetUserId, skipping...',
          );
        }
        return;
      }
      ...
      if (kDebugMode) {
        ...
        print(
          '   following array exists: ${currentUserData.containsKey('following')}',
        );
        ...
        print(
          '   Already contains targetUserId: ${currentFollowing.contains(targetUserId)}',
        );
      }
      ...
      if (!currentUserData.containsKey('following')) {
        if (kDebugMode) {
          print(
            '⚠️ [followUser] following array does not exist, creating it...',
          );
        }
      ...
      if (kDebugMode) {
        ...
        final verifyFollowing =
            (verifyData['following'] as List<dynamic>?) ?? [];
        print(
          '   Verification - following array length: ${verifyFollowing.length}',
        );
        print(
          '   Verification - followingCount: ${verifyData['followingCount']}',
        );
        print(
          '   Verification - contains targetUserId: ${verifyFollowing.contains(targetUserId)}',
        );
      }
    } catch (e, stackTrace) {
      if (kDebugMode) {
  ...
  Future<void> unfollowUser(String currentUserId, String targetUserId) async {
    try {
      ...
      final currentFollowingCount =
          (currentUserData['followingCount'] as int?) ?? 0;
      final targetFollowersCount =
          (targetUserData['followersCount'] as int?) ?? 0;

      final batch = _firestore.batch();

      // Remove targetUserId from currentUserId's following array
      final currentUserRef = _firestore.collection('users').doc(currentUserId);
      final newCurrentFollowingCount =
          (currentFollowingCount - 1).clamp(0, double.infinity).toInt();
      batch.update(currentUserRef, {
      ...
      final targetUserRef = _firestore.collection('users').doc(targetUserId);
      final newTargetFollowersCount =
          (targetFollowersCount - 1).clamp(0, double.infinity).toInt();
      batch.update(targetUserRef, {
      ...
      if (kDebugMode) {
        ...
        print(
          '   Current user following: $currentFollowingCount -> $newCurrentFollowingCount',
        );
        print(
          '   Target user followers: $targetFollowersCount -> $newTargetFollowersCount',
        );
      }
    } catch (e, stackTrace) {
      final exception = ExceptionMapper.mapToAppException(e, stackTrace);
  ...
  Future<Map<String, dynamic>> getFollowersPaginated(
    ...
    try {
          ...
          if (followerDoc.exists) {
            ...
            followers.add({
              ...
              'username':
                  ...
                  '@${followerId.toString().substring(0, 8)}',
              'image':
                  followerData['photoUrl'] ??
                  followerData['profilePhotoUrl'] ??
                  '',
              'photoUrl':
                  followerData['photoUrl'] ?? followerData['profilePhotoUrl'],
            });
          }
        } catch (e) {
          if (kDebugMode) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getFollowersPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> getFollowingPaginated(
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          '📄 [FirestoreService.getFollowingPaginated] User document exists: ${userDoc.exists}',
        );
      }
      ...
      if (!userDoc.exists) {
        if (kDebugMode) {
          print(
            '⚠️ [FirestoreService.getFollowingPaginated] User document does not exist',
          );
        }
        return {
      ...
      if (kDebugMode) {
        print(
          '📊 [FirestoreService.getFollowingPaginated] User document data keys: ${data?.keys}',
        );
      }
      ...
      if (followingIds.isEmpty) {
        if (kDebugMode) {
          print(
            'ℹ️ [FirestoreService.getFollowingPaginated] No following IDs found, returning empty list',
          );
        }
        return {
          'following': <Map<String, dynamic>>[],
        ...
        try {
          ...
          if (followingDoc.exists) {
            ...
            if (kDebugMode) {
              ...
              print(
                '      profilePhotoUrl: ${followingData['profilePhotoUrl']}',
              );
            }
            ...
            final userData = {
              ...
              'name':
                  followingData['displayName'] ??
                  followingData['name'] ??
                  'Unknown User',
              'username':
                  followingData['username'] ??
                  '@${followingId.toString().substring(0, 8)}',
              'image':
                  followingData['photoUrl'] ??
                  followingData['profilePhotoUrl'] ??
                  '',
              'photoUrl':
                  followingData['photoUrl'] ?? followingData['profilePhotoUrl'],
            };
            ...
            if (kDebugMode) {
              print(
                '      ⚠️ User document does not exist for followingId: $followingId',
              );
            }
          }
        } catch (e) {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getFollowingPaginated',
      );
      rethrow;
    }
  }
  ...
  Future<int> getFollowerCount(String userId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getFollowerCount',
      );
      return 0;
    }
  }
  ...
  Future<int> getFollowingCount(String userId) async {
    try {
      ...
      _errorHandler.handleError(
        exception,
        stackTrace,
        'FirestoreService.getFollowingCount',
      );
      return 0;
    }
  }
